...
results_forplot$outcome2[results_forplot$outcome=="funclimits"]<-"Physical functional \nlimitations"
...
pred_forplot$outcome2[pred_forplot$outcome=="funclimits"]<-"Physical functional limitations"
...
pred_forplot$outcome2<-factor(pred_forplot$outcome2, levels = c("Fair/poor health", "Elevated depressive symptoms",
                                                                "Physical functional limitations", "Elevated anxiety
